...
import { Clock, DollarSign, Heart, Package, Plus, Settings, ShoppingCart, User, Trophy, Eye } from "lucide-react"
                        ...
                        <div className="flex-1">
                          ...
                          <div className="mt-3 flex items-center gap-2">
                            <Link href={`/auctions/${auction.id}`} passHref>
                              <Button
                                size="sm"
                                className="h-8 bg-rose-600 hover:bg-rose-700 dark:bg-rose-600 dark:hover:bg-rose-700"
                              >
                                Increase Bid
                              </Button>
                            </Link>
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="mt-1 text-sm text-muted-foreground">Status: {auction.status}</div>
                          <div className="mt-3 flex items-center gap-2">
                            <Button
                              size="sm"
                              className="h-8 bg-rose-600 hover:bg-rose-700 dark:bg-rose-600 dark:hover:bg-rose-700"
